          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input
                  value={Array.isArray(formData.defaultKeywords) ? formData.defaultKeywords.join(', ') : (formData.defaultKeywords || "")}
                  onChange={(e) => {
                    const value = e.target.value;
                    const keywordsArray = value ? value.split(',').map(k => k.trim()).filter(k => k.length > 0) : [];
                    handleChange("defaultKeywords", keywordsArray);
                  }}
