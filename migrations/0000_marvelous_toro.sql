...
CREATE TABLE "aws_credentials" (
	...
	"enabled_services" jsonb DEFAULT '{"polly":true,"bedrock":true}'::jsonb,
	"polly_voice_engine" text DEFAULT 'neural' NOT NULL,
	"bedrock_default_model" text DEFAULT 'anthropic.claude-3-5-sonnet-20241022-v2:0',
...
CREATE TABLE "call_qa_analyses" (
	...
	"max_response_latency" integer,
	"has_hallucinations" boolean DEFAULT false,
	"has_interruptions" boolean DEFAULT false,
	"has_negative_sentiment" boolean DEFAULT false,
	"has_compliance_issues" boolean DEFAULT false,
	"has_kb_inaccuracies" boolean DEFAULT false,
	"diagnostics" jsonb,
	"key_moments" jsonb,
	"evidence" jsonb,
	"analysis_model" text,
...
CREATE TABLE "crawl_jobs" (
	...
	"crawl_type" text DEFAULT 'single' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "department_knowledge_bases" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"department_id" varchar NOT NULL,
...
CREATE TABLE "generated_articles" (
	...
	"content_html" text,
	"summary" text,
	"article_type" text DEFAULT 'article' NOT NULL,
	"topic_id" varchar,
	"source_knowledge_base_ids" text[],
...
--> statement-breakpoint
CREATE TABLE "ivr_configurations" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" varchar NOT NULL,
	"phone_number_id" varchar,
	"name" text DEFAULT 'Auto Distribution' NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	...
	"fallback_department_id" varchar,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "knowledge_pipeline_jobs" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" varchar NOT NULL,
	"crawl_job_id" varchar,
	"name" text NOT NULL,
	"status" text DEFAULT 'pending' NOT NULL,
	"current_stage" text DEFAULT 'crawling' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "knowledge_topic_assignments" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "ml_analysis_jobs" (
	...
	"training_samples_created" integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "ml_conversation_analyses" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" varchar NOT NULL,
	"call_id" varchar NOT NULL,
	"analysis_job_id" varchar,
	"sentiment" text,
...
CREATE TABLE "ml_training_samples" (
	...
	"used_in_training_at" timestamp,
	"training_batch_id" varchar,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "ml_training_stats" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" varchar NOT NULL,
	"total_calls_analyzed" integer DEFAULT 0 NOT NULL,
	"total_issues_discovered" integer DEFAULT 0 NOT NULL,
	"total_training_samples" integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "provider_caller_ids" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"user_id" varchar NOT NULL,
	...
	"country_code" text,
	"number_type" text DEFAULT 'voice',
	"status" text DEFAULT 'active' NOT NULL,
	"is_default" boolean DEFAULT false NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL
...
--> statement-breakpoint
CREATE TABLE "tcxc_credentials" (
	"id" varchar PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"name" text NOT NULL,
	"api_login" text NOT NULL,
	"api_key" text NOT NULL,
	"api_endpoint" text DEFAULT 'https://api.telecomxchange.com',
	"is_primary" boolean DEFAULT false NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"health_status" text DEFAULT 'unknown' NOT NULL,
	"last_health_check" timestamp,
	"tech_prefixes" text[] DEFAULT ARRAY[]::text[],
	"connection_type" text DEFAULT 'tcxc',
	"sip_server" text,
...
ALTER TABLE "call_qa_analyses" ADD CONSTRAINT "call_qa_analyses_call_id_calls_id_fk" FOREIGN KEY ("call_id") REFERENCES "public"."calls"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "call_qa_analyses" ADD CONSTRAINT "call_qa_analyses_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "content_audit_log" ADD CONSTRAINT "content_audit_log_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "crawl_jobs" ADD CONSTRAINT "crawl_jobs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "crawl_jobs" ADD CONSTRAINT "crawl_jobs_folder_id_knowledge_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."knowledge_folders"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "crawl_pages" ADD CONSTRAINT "crawl_pages_crawl_job_id_crawl_jobs_id_fk" FOREIGN KEY ("crawl_job_id") REFERENCES "public"."crawl_jobs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "crawl_pages" ADD CONSTRAINT "crawl_pages_knowledge_base_id_knowledge_base_id_fk" FOREIGN KEY ("knowledge_base_id") REFERENCES "public"."knowledge_base"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "department_knowledge_bases" ADD CONSTRAINT "department_knowledge_bases_department_id_departments_id_fk" FOREIGN KEY ("department_id") REFERENCES "public"."departments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "department_knowledge_bases" ADD CONSTRAINT "department_knowledge_bases_knowledge_base_id_knowledge_base_id_fk" FOREIGN KEY ("knowledge_base_id") REFERENCES "public"."knowledge_base"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "generated_articles" ADD CONSTRAINT "generated_articles_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "generated_articles" ADD CONSTRAINT "generated_articles_folder_id_knowledge_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."knowledge_folders"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "generated_articles" ADD CONSTRAINT "generated_articles_topic_id_knowledge_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."knowledge_topics"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ivr_configurations" ADD CONSTRAINT "ivr_configurations_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ivr_configurations" ADD CONSTRAINT "ivr_configurations_phone_number_id_phone_numbers_id_fk" FOREIGN KEY ("phone_number_id") REFERENCES "public"."phone_numbers"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ivr_configurations" ADD CONSTRAINT "ivr_configurations_fallback_department_id_departments_id_fk" FOREIGN KEY ("fallback_department_id") REFERENCES "public"."departments"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "knowledge_base" ADD CONSTRAINT "knowledge_base_folder_id_knowledge_folders_id_fk" FOREIGN KEY ("folder_id") REFERENCES "public"."knowledge_folders"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "knowledge_entities" ADD CONSTRAINT "knowledge_entities_knowledge_base_id_knowledge_base_id_fk" FOREIGN KEY ("knowledge_base_id") REFERENCES "public"."knowledge_base"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_faqs" ADD CONSTRAINT "knowledge_faqs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_faqs" ADD CONSTRAINT "knowledge_faqs_knowledge_base_id_knowledge_base_id_fk" FOREIGN KEY ("knowledge_base_id") REFERENCES "public"."knowledge_base"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_faqs" ADD CONSTRAINT "knowledge_faqs_source_chunk_id_knowledge_chunks_id_fk" FOREIGN KEY ("source_chunk_id") REFERENCES "public"."knowledge_chunks"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_faqs" ADD CONSTRAINT "knowledge_faqs_verified_by_users_id_fk" FOREIGN KEY ("verified_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_folders" ADD CONSTRAINT "knowledge_folders_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_graph_edges" ADD CONSTRAINT "knowledge_graph_edges_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_graph_edges" ADD CONSTRAINT "knowledge_graph_edges_source_node_id_knowledge_graph_nodes_id_fk" FOREIGN KEY ("source_node_id") REFERENCES "public"."knowledge_graph_nodes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_graph_edges" ADD CONSTRAINT "knowledge_graph_edges_target_node_id_knowledge_graph_nodes_id_fk" FOREIGN KEY ("target_node_id") REFERENCES "public"."knowledge_graph_nodes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_graph_edges" ADD CONSTRAINT "knowledge_graph_edges_source_chunk_id_knowledge_chunks_id_fk" FOREIGN KEY ("source_chunk_id") REFERENCES "public"."knowledge_chunks"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_graph_nodes" ADD CONSTRAINT "knowledge_graph_nodes_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_graph_nodes" ADD CONSTRAINT "knowledge_graph_nodes_entity_id_knowledge_entities_id_fk" FOREIGN KEY ("entity_id") REFERENCES "public"."knowledge_entities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_pipeline_jobs" ADD CONSTRAINT "knowledge_pipeline_jobs_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_pipeline_jobs" ADD CONSTRAINT "knowledge_pipeline_jobs_crawl_job_id_crawl_jobs_id_fk" FOREIGN KEY ("crawl_job_id") REFERENCES "public"."crawl_jobs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "knowledge_topic_assignments" ADD CONSTRAINT "knowledge_topic_assignments_topic_id_knowledge_topics_id_fk" FOREIGN KEY ("topic_id") REFERENCES "public"."knowledge_topics"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "knowledge_topic_assignments" ADD CONSTRAINT "knowledge_topic_assignments_knowledge_base_id_knowledge_base_id_fk" FOREIGN KEY ("knowledge_base_id") REFERENCES "public"."knowledge_base"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ml_common_issues" ADD CONSTRAINT "ml_common_issues_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_common_issues" ADD CONSTRAINT "ml_common_issues_approved_by_users_id_fk" FOREIGN KEY ("approved_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_conversation_analyses" ADD CONSTRAINT "ml_conversation_analyses_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_conversation_analyses" ADD CONSTRAINT "ml_conversation_analyses_call_id_calls_id_fk" FOREIGN KEY ("call_id") REFERENCES "public"."calls"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_conversation_analyses" ADD CONSTRAINT "ml_conversation_analyses_analysis_job_id_ml_analysis_jobs_id_fk" FOREIGN KEY ("analysis_job_id") REFERENCES "public"."ml_analysis_jobs"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_training_samples" ADD CONSTRAINT "ml_training_samples_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_training_samples" ADD CONSTRAINT "ml_training_samples_source_call_id_calls_id_fk" FOREIGN KEY ("source_call_id") REFERENCES "public"."calls"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_training_samples" ADD CONSTRAINT "ml_training_samples_common_issue_id_ml_common_issues_id_fk" FOREIGN KEY ("common_issue_id") REFERENCES "public"."ml_common_issues"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_training_samples" ADD CONSTRAINT "ml_training_samples_reviewed_by_users_id_fk" FOREIGN KEY ("reviewed_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ml_training_stats" ADD CONSTRAINT "ml_training_stats_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "provider_caller_ids" ADD CONSTRAINT "provider_caller_ids_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "provider_caller_ids" ADD CONSTRAINT "provider_caller_ids_credential_id_tcxc_credentials_id_fk" FOREIGN KEY ("credential_id") REFERENCES "public"."tcxc_credentials"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
