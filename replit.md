...
- **Bedrock Model Upgrade to Claude Sonnet 4 & Opus 4 (Mar 2026)**:
  ...
  - **Model Fallback**: `streamBedrockAndSpeak` now attempts primary model first; on failure, automatically falls back to `claude-3-5-sonnet` with logged warning. Prevents silent call failures.
