...
const IVR_DEPT_NAME_TRANSLATIONS: Record<string, Record<string, string>> = {
  Sales: { en: 'Sales', fr: 'Ventes', it: 'Vendite', zh: '\u9500\u552E', hi: '\u092C\u093F\u0915\u094D\u0930\u0940', ar: '\u0627\u0644\u0645\u0628\u064A\u0639\u0627\u062A', es: 'Ventas', de: 'Vertrieb', ja: '\u55B6\u696D', ko: '\uC601\uC5C5', pt: 'Vendas', ru: '\u041F\u0440\u043E\u0434\u0430\u0436\u0438', tr: 'Sat\u0131\u015F', ur: '\u0633\u06CC\u0644\u0632' },
  Support: { en: 'Support', fr: 'Assistance', it: 'Supporto', zh: '\u5BA2\u670D', hi: '\u0938\u0939\u093E\u092F\u0924\u093E', ar: '\u0627\u0644\u062F\u0639\u0645', es: 'Soporte', de: 'Kundendienst', ja: '\u30B5\u30DD\u30FC\u30C8', ko: '\uACE0\uAC1D \uC9C0\uC6D0', pt: 'Suporte', ru: '\u041F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0430', tr: 'Destek', ur: '\u0633\u067E\u0648\u0631\u0679' },
  Scheduling: { en: 'Scheduling', fr: 'Planification', it: 'Programmazione', zh: '\u9884\u7EA6', hi: '\u0936\u0947\u0921\u094D\u092F\u0942\u0932\u093F\u0902\u0917', ar: '\u0627\u0644\u062C\u062F\u0648\u0644\u0629', es: 'Citas', de: 'Terminvereinbarung', ja: '\u4E88\u7D04', ko: '\uC608\uC57D', pt: 'Agendamento', ru: '\u0417\u0430\u043F\u0438\u0441\u044C \u043D\u0430 \u043F\u0440\u0438\u0451\u043C', tr: 'Randevu', ur: '\u0627\u067E\u0627\u0626\u0646\u0679\u0645\u0646\u0679' },
  Billing: { en: 'Billing', fr: 'Facturation', it: 'Fatturazione', zh: '\u8D26\u5355', hi: '\u092C\u093F\u0932\u093F\u0902\u0917', ar: '\u0627\u0644\u0641\u0648\u0627\u062A\u064A\u0631', es: 'Facturaci\u00f3n', de: 'Rechnungsabteilung', ja: '\u8ACB\u6C42', ko: '\uCCAD\uAD6C', pt: 'Faturamento', ru: '\u0412\u044B\u0441\u0442\u0430\u0432\u043B\u0435\u043D\u0438\u0435 \u0441\u0447\u0435\u0442\u043E\u0432', tr: 'Fatura', ur: '\u0628\u0644\u0646\u06AF' },
  'Technical Support': { en: 'Technical Support', fr: 'Support Technique', it: 'Supporto Tecnico', zh: '\u6280\u672F\u652F\u6301', hi: '\u0924\u0915\u0928\u0940\u0915\u0940 \u0938\u0939\u093E\u092F\u0924\u093E', ar: '\u0627\u0644\u062F\u0639\u0645 \u0627\u0644\u0641\u0646\u064A', es: 'Soporte T\u00e9cnico', de: 'Technischer Support', ja: '\u30C6\u30AF\u30CB\u30AB\u30EB\u30B5\u30DD\u30FC\u30C8', ko: '\uAE30\uC220 \uC9C0\uC6D0', pt: 'Suporte T\u00e9cnico', ru: '\u0422\u0435\u0445\u043D\u0438\u0447\u0435\u0441\u043A\u0430\u044F \u043F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0430', tr: 'Teknik Destek', ur: '\u0679\u06CC\u06A9\u0646\u06CC\u06A9\u0644 \u0633\u067E\u0648\u0631\u0679' },
  'Customer Service': { en: 'Customer Service', fr: 'Service Client', it: 'Servizio Clienti', zh: '\u5BA2\u6237\u670D\u52A1', hi: '\u0917\u094D\u0930\u093E\u0939\u0915 \u0938\u0947\u0935\u093E', ar: '\u062E\u062F\u0645\u0629 \u0627\u0644\u0639\u0645\u0644\u0627\u0621', es: 'Atenci\u00f3n al Cliente', de: 'Kundenservice', ja: '\u30AB\u30B9\u30BF\u30DE\u30FC\u30B5\u30FC\u30D3\u30B9', ko: '\uACE0\uAC1D \uC11C\uBE44\uC2A4', pt: 'Atendimento ao Cliente', ru: '\u041E\u0431\u0441\u043B\u0443\u0436\u0438\u0432\u0430\u043D\u0438\u0435 \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432', tr: 'M\u00fc\u015Fteri Hizmetleri', ur: '\u06A9\u0633\u0679\u0645\u0631 \u0633\u0631\u0648\u0633' },
  Appointments: { en: 'Appointments', fr: 'Rendez-vous', it: 'Appuntamenti', zh: '\u9884\u7EA6', hi: '\u0905\u092A\u0949\u0907\u0902\u091F\u092E\u0947\u0902\u091F', ar: '\u0627\u0644\u0645\u0648\u0627\u0639\u064A\u062F', es: 'Citas', de: 'Termine', ja: '\u4E88\u7D04', ko: '\uC608\uC57D', pt: 'Agendamento', ru: '\u0417\u0430\u043F\u0438\u0441\u044C', tr: 'Randevu', ur: '\u0627\u067E\u0627\u0626\u0646\u0679\u0645\u0646\u0679' },
  General: { en: 'General', fr: 'G\u00e9n\u00e9ral', it: 'Generale', zh: '\u901A\u7528', hi: '\u0938\u093E\u092E\u093E\u0928\u094D\u092F', ar: '\u0639\u0627\u0645', es: 'General', de: 'Allgemein', ja: '\u4E00\u822C', ko: '\uC77C\uBC18', pt: 'Geral', ru: '\u041E\u0431\u0449\u0438\u0439', tr: 'Genel', ur: '\u0639\u0645\u0648\u0645\u06CC' },
  Marketing: { en: 'Marketing', fr: 'Marketing', it: 'Marketing', zh: '\u5E02\u573A\u8425\u9500', hi: '\u092E\u093E\u0930\u094D\u0915\u0947\u091F\u093F\u0902\u0917', ar: '\u0627\u0644\u062A\u0633\u0648\u064A\u0642', es: 'Marketing', de: 'Marketing', ja: '\u30DE\u30FC\u30B1\u30C6\u30A3\u30F3\u30B0', ko: '\uB9C8\uCF00\uD305', pt: 'Marketing', ru: '\u041C\u0430\u0440\u043A\u0435\u0442\u0438\u043D\u0433', tr: 'Pazarlama', ur: '\u0645\u0627\u0631\u06A9\u06CC\u0679\u0646\u06AF' },
  'Human Resources': { en: 'Human Resources', fr: 'Ressources Humaines', it: 'Risorse Umane', zh: '\u4EBA\u529B\u8D44\u6E90', hi: '\u092E\u093E\u0928\u0935 \u0938\u0902\u0938\u093E\u0927\u0928', ar: '\u0627\u0644\u0645\u0648\u0627\u0631\u062F \u0627\u0644\u0628\u0634\u0631\u064A\u0629', es: 'Recursos Humanos', de: 'Personalabteilung', ja: '\u4EBA\u4E8B', ko: '\uC778\uC0AC', pt: 'Recursos Humanos', ru: '\u041A\u0430\u0434\u0440\u044B', tr: '\u0130nsan Kaynaklar\u0131', ur: '\u06C1\u06CC\u0648\u0645\u0646 \u0631\u06CC\u0633\u0648\u0631\u0633\u0632' },
  Complaints: { en: 'Complaints', fr: 'R\u00e9clamations', it: 'Reclami', zh: '\u6295\u8BC9', hi: '\u0936\u093F\u0915\u093E\u092F\u0924', ar: '\u0627\u0644\u0634\u0643\u0627\u0648\u0649', es: 'Quejas', de: 'Beschwerden', ja: '\u82E6\u60C5', ko: '\uBD88\uB9CC', pt: 'Reclama\u00e7\u00f5es', ru: '\u0416\u0430\u043B\u043E\u0431\u044B', tr: '\u015Eik\u00e2yet', ur: '\u0634\u06A9\u0627\u06CC\u0627\u062A' },
};
...
function isNonPollyVoice(voiceId: string | null | undefined): boolean {
    ...
    if (langOptions && langOptions.length > 1) {
      ...
      if (!hasLangOptions) {
        for (let idx = 0; idx < langOptions.length; idx++) {
          ...
          const optVoiceId = opt.voiceId || null;
...
export async function handleIvrSelection(req: Request, res: Response) {
  try {
    ...
    if (!selectedOption) {
      ...
      sayWithVoice(gather, deptMenuPrompt);
      response.hangup();
      res.type('text/xml');
      return res.send(response.toString());
    }
