...
const INTEGRATION_APPS = [
  ...
  // ═══════════════════════════════════════════
  // Telephony & VoIP — Phone infrastructure for calls
  // ═══════════════════════════════════════════
  {
    name: 'Twilio',
    slug: 'twilio',
    description: 'Provide phone numbers and SIP trunking for outbound/inbound AI agent calls via Twilio.',
    category: 'telephony',
    logoUrl: null,
  ...
  },
  {
    ...
    category: 'telephony',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.vonage',
    isPopular: false,
    isActive: true,
  },
  {
    name: 'Bandwidth',
    slug: 'bandwidth',
    description: 'Enterprise-grade telephony for AI agent calls with Bandwidth voice and messaging APIs.',
    category: 'telephony',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Telnyx',
    slug: 'telnyx',
    description: 'Low-latency SIP trunking and phone numbers for AI voice agent calls via Telnyx.',
    category: 'telephony',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Amazon Connect',
    slug: 'amazon-connect',
    description: 'Connect AI agents to Amazon Connect contact center for enterprise call routing and analytics.',
    category: 'telephony',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.awsComprehend',
    isPopular: false,
    isActive: true,
  },

  // ═══════════════════════════════════════════
  // AI & LLM — Language models powering agent conversations
  // ═══════════════════════════════════════════
  {
    name: 'OpenAI',
    slug: 'openai',
    description: 'Power your AI agents with GPT-4o and other OpenAI models for natural, intelligent conversations.',
    category: 'ai_llm',
    logoUrl: null,
  ...
  },
  {
    ...
    slug: 'anthropic',
    description: 'Use Claude models from Anthropic for highly accurate, safety-aware AI agent conversations.',
    category: 'ai_llm',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: true,
  ...
  },
  {
    name: 'Google Gemini',
    slug: 'google-gemini',
    description: 'Leverage Google Gemini multimodal AI for advanced agent intelligence and reasoning.',
    category: 'ai_llm',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Mistral AI',
    slug: 'mistral',
    description: 'Deploy fast, cost-effective AI agents using Mistral open-weight language models.',
    category: 'ai_llm',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Groq',
    slug: 'groq',
    description: 'Ultra-fast LLM inference with Groq for low-latency, real-time AI agent responses.',
    category: 'ai_llm',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Cohere',
    slug: 'cohere',
    description: 'Use Cohere language models for enterprise-grade AI agent conversations with RAG support.',
    category: 'ai_llm',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Perplexity AI',
    slug: 'perplexity',
    description: 'Enable AI agents with real-time web search capabilities through Perplexity AI models.',
    category: 'ai_llm',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  // ═══════════════════════════════════════════
  // Voice & Speech — TTS and STT engines
  // ═══════════════════════════════════════════
  {
    name: 'ElevenLabs',
    slug: 'elevenlabs',
    description: 'Generate ultra-realistic AI voices for your agents with ElevenLabs text-to-speech technology.',
  ...
  },
  {
    name: 'Deepgram',
    slug: 'deepgram',
    description: 'Real-time speech-to-text transcription with industry-leading accuracy for AI call analysis.',
    category: 'voice_speech',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    ...
    description: 'Natural-sounding text-to-speech voices from Google Cloud for multilingual AI agents.',
    category: 'voice_speech',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.googleCloudTextToSpeech',
    isPopular: false,
    isActive: true,
  },
  {
    name: 'Amazon Polly',
    slug: 'amazon-polly',
    description: 'AWS Polly text-to-speech for lifelike voices with Neural and Standard voice options.',
    category: 'voice_speech',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.awsPolly',
    isPopular: false,
    isActive: true,
  },
  {
    name: 'Azure Speech',
    slug: 'azure-speech',
    description: 'Microsoft Azure Speech Services for high-quality TTS and STT with 100+ voices and languages.',
    category: 'voice_speech',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'PlayHT',
    slug: 'playht',
    description: 'Clone voices and generate natural speech for AI agents using PlayHT voice synthesis.',
    category: 'voice_speech',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
  ...
  },
  {
    name: 'Murf AI',
    slug: 'murf',
    description: 'Studio-quality AI voice generation for professional-sounding agent conversations via Murf.',
    category: 'voice_speech',
    logoUrl: null,
    n8nNodeType: 'n8n-nodes-base.httpRequest',
    isPopular: false,
